...
* Please note that the first row is reserved for column names
 ...
 Example templates for all lipid classes currently covered by LICAR are available on [GitHub](https://github.com/SLINGhub/LICAR/).
 Please note that:
...
### 2.4.Run the Shiny App
 ...
 Open the script `LICAR_UI.R` in the `R` directory and click on the 'Run App' button.
