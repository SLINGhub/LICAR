...
### Multiple transitions with 'LCB' as product ion
...
### CAREFUL: Mix of transitions where 'head group' or 'LCB' as product ion

The script treats below PC 38:2 as transition with LCB fragment.. (!?) User has to make sure that the lipid_fragment_class is set correctly
